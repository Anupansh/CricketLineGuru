...
class RecentMatchAdCell: UITableViewCell {
    ...
    func configureCell(recentData:CLGRecentMatchModelV3,vc:UIViewController,path:String){
    ...
    func configureCellTeam(recentData:CLGRecentMatchModel,vc:UIViewController,path:String){
        self.gadBannerView.adUnitID = AppHelper.appDelegate().adBannerUnitID as String
        self.gadBannerView.rootViewController = vc
        self.gadBannerView.load(GADRequest())
        self.ImgViewLeftTeam.image = #imageLiteral(resourceName: "TeamPlaceholder")
