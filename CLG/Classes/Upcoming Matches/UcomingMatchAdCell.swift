...
class UcomingMatchAdCell: UITableViewCell {
    ...
    func configureCell(upcomingData:CLGRecentMatchModelV3,vc:UIViewController,path:String){
...
func configureCellTeam(upcomingData:CLGRecentMatchModel,vc:UIViewController,path:String){
    self.gadBannerView.adUnitID = AppHelper.appDelegate().adBannerUnitID as String
    self.gadBannerView.rootViewController = vc
    self.gadBannerView.load(GADRequest())
